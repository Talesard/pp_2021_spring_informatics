...
TEST(dijkstra_algorithm, eight_point) {
    std::vector<int> result = { 5, 6, 3, 1 };

    std::vector<int> graf = { 0, 6, 8, 0, 0, 13,
                          6, 0, 9, 14, 0, 0,
                          8, 9, 0, 10, 0, 1,
                          0, 14, 10, 0, 5, 0,
                          0, 0, 0, 5, 0, 8,
...
TEST(dijkstra_algorithm, test_parallel_six_point) {
    ...
    EXPECT_EQ(dijkstra_parallel(graf, 1, 5), result);
}

TEST(dijkstra_algorithm, nine_point) {
    std::vector<int> result = { 5, 6, 3, 1 };
...
TEST(dijkstra_algorithm, six_point_nomer_3_parallel) {
    std::vector<int> result = { 5, 6, 3, 1 };
